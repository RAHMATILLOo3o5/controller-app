...
<div class="wrapper vh-100">
    <div class="row align-items-center h-100">
        ...
        ])->label('Foydalanuvchi nomi', ['class' => 'sr-only']); ?>

        <?= $form->field($model, 'password')->passwordInput(['id' => 'password', 'class' => 'form-control form-control-lg', 'placeholder' => 'Parol'])->label('Parol', ['class' => 'sr-only']); ?>

        <?php echo  $form->field($model, 'rememberMe')->checkbox()->label('Meni eslab qol') ?>
