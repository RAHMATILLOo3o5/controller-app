!function (t, e) {
    ...
    var I = (n(C, [{
        ...
        key: "escapeString", value: function (t) {
            var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : "x", i = t.toString().slice();
        ...
        key: "addLightenFilter", value: function (t, i, e) {
            var a = this, s = this.w, r = e.intensity;
        ...
        key: "addDarkenFilter", value: function (t, i, e) {
            ...
            I.isFirefox() || (t.unfilter(!0), new window.SVG.Filter, t.filter(function (t) {
                var e = s.config.chart.dropShadow;
                (e.enabled ? a.addShadow(t, i, e) : t).componentTransfer({rgb: {type: "linear", slope: r}})
            }), t.filterer.node.setAttribute("filterUnits", "userSpaceOnUse"), this._scaleFilterSize(t.filterer.node))
        }
    }, {
        ...
        key: "animatePathsGradually", value: function (t) {
            var e = t.el, i = t.realIndex, a = t.j, s = t.fill, r = t.pathFrom, n = t.pathTo, o = t.speed, l = t.delay,
                h = this.w, c = 0;
        ...
        key: "drawPath", value: function (t) {
            var e = t.d, i = void 0 === e ? "" : e, a = t.stroke, s = void 0 === a ? "#a8a8a8" : a, r = t.strokeWidth,
                n = void 0 === r ? 1 : r, o = t.fill, l = t.fillOpacity, h = void 0 === l ? 1 : l, c = t.strokeOpacity,
                d = void 0 === c ? 1 : c, g = t.classes, u = t.strokeLinecap, p = void 0 === u ? null : u,
                f = t.strokeDashArray, x = void 0 === f ? 0 : f, b = this.w;
        ...
        key: "renderPaths", value: function (t) {
            var e, i = t.j, a = t.realIndex, s = t.pathFrom, r = t.pathTo, n = t.stroke, o = t.strokeWidth,
                ...
                b = void 0 === x || x, m = t.drawShadow, v = void 0 === m || m, y = this.w, w = new E(this.ctx),
                k = new X(this.ctx), A = this.w.config.chart.animations.enabled,
            ...
            var L, P = y.config.stroke.dashArray, T = Array.isArray(P) ? P[a] : y.config.stroke.dashArray,
                z = this.drawPath({
                    d: e,
                    stroke: n,
                    strokeWidth: o,
            ...
            z.attr("index", a), f && z.attr({"clip-path": "url(#gridRectMask".concat(y.globals.cuid, ")")}), "none" !== y.config.states.normal.filter.type ? w.getDefaultFilter(z, a) : y.config.chart.dropShadow.enabled && v && (!y.config.chart.dropShadow.enabledOnSeries || y.config.chart.dropShadow.enabledOnSeries && -1 !== y.config.chart.dropShadow.enabledOnSeries.indexOf(a)) && (L = y.config.chart.dropShadow, w.dropShadow(z, L, a)), b && (z.node.addEventListener("mouseenter", this.pathMouseEnter.bind(this, z)), z.node.addEventListener("mouseleave", this.pathMouseLeave.bind(this, z)), z.node.addEventListener("mousedown", this.pathMouseDown.bind(this, z))), z.attr({
                pathTo: r,
                pathFrom: s
            });
            var I = {el: z, j: i, realIndex: a, pathFrom: s, pathTo: r, fill: h, strokeWidth: o, delay: c};
            return !A || y.globals.resized || y.globals.dataChanged ? !y.globals.resized && y.globals.dataChanged || k.showDelayedElements() : k.animatePathsGradually(M(M({}, I), {}, {speed: d})), y.globals.dataChanged && S && C && k.animatePathsGradually(M(M({}, I), {}, {speed: g})), z
        }
    }, {
        key: "drawPattern", value: function (e, i, a) {
            ...
            return this.w.globals.dom.Paper.pattern(i, a, function (t) {
                "horizontalLines" === e ? t.line(0, 0, a, 0).stroke({
                    ...
                    color: s,
                    width: r
                }) : "circles" === e && t.circle(i).fill("none").stroke({color: s, width: r})
            })
        }
    }, {
        ...
        key: "drawText", value: function (t) {
            var e, i = t.x, a = t.y, s = t.text, r = t.textAnchor, n = t.fontSize, o = t.fontFamily, l = t.fontWeight,
                h = t.foreColor, c = t.opacity, d = t.cssClass, g = void 0 === d ? "" : d, u = t.isPlainText,
                p = void 0 === u || u, f = this.w;
        ...
        key: "pathMouseEnter", value: function (t, e) {
            var i, a = this.w, s = new E(this.ctx), r = parseInt(t.node.getAttribute("index"), 10),
        ...
        key: "pathMouseLeave", value: function (t, e) {
            var i = this.w, a = new E(this.ctx), s = parseInt(t.node.getAttribute("index"), 10),
        ...
        key: "pathMouseDown", value: function (t, e) {
            var i, a, s, r, n, o = this.w, l = new E(this.ctx), h = parseInt(t.node.getAttribute("index"), 10),
                c = parseInt(t.node.getAttribute("j"), 10), d = "false";
        ...
        key: "getTextRects", value: function (t, e, i, a) {
            var s = !(4 < arguments.length && void 0 !== arguments[4]) || arguments[4], r = this.w, n = this.drawText({
                x: -200,
                y: -200,
                text: t,
                textAnchor: "start",
        ...
        key: "placeTextWithEllipsis", value: function (t, e, i) {
            if ("function" == typeof t.getComputedTextLength && 0 < (t.textContent = e).length && t.getComputedTextLength() >= i / .8) {
                for (var a = e.length - 3; 0 < a; a -= 3) if (t.getSubStringLength(0, a) <= i / .8) return void (t.textContent = e.substring(0, a) + "...");
                t.textContent = "."
            }
        }
    }], [{
        ...
        key: "setOrientations", value: function (t) {
            var e, i, a, s, r, n, o = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : null, l = this.w;
        ...
        key: "makeAnnotationDraggable", value: function (e, t, i) {
            var r = this.w.config.annotations[t][i];
            e.draggable().on("dragend", function (t) {
                var e = t.target.getAttribute("x"), i = t.target.getAttribute("y"), a = t.target.getAttribute("cx"),
                ...
                t.stopPropagation(), e.selectize({
                    ...
                    var e = t.target.getAttribute("width"), i = t.target.getAttribute("height"),
        ...
        key: "addXaxisAnnotation", value: function (t, e, i) {
            var a = this.w, s = this.invertAxis ? a.globals.minY : a.globals.minX,
                ...
                n = this.invertAxis ? a.globals.yRange[0] : a.globals.xRange, o = (t.x - s) / (n / a.globals.gridWidth);
            ...
            })).attr({rel: i}), e.appendChild(f.node), this.annoCtx.helpers.setOrientations(t, i))
        }
    }, {
        ...
        key: "getSeriesTotalsXRange", value: function (s, r) {
            var n = this.w;
        ...
        key: "getPercentSeries", value: function () {
            ...
            o.globals.seriesPercent = o.globals.series.map(function (t, e) {
                ...
                if (Array.isArray(t)) for (var a = 0; a < t.length; a++) {
                    var s = o.globals.stackedSeriesTotals[a], r = 0;
        ...
        key: "getLogYRatios", value: function (t) {
            var r = this, n = this.w, o = this.w.globals;
        ...
        key: "addYaxisAnnotation", value: function (t, e, i) {
            var a, s, r, n, o = this.w, l = t.strokeDashArray, h = this._getY1Y2("y1", t), c = t.label.text;
            ...
            var d = "right" === t.label.position ? o.globals.gridWidth : 0, g = this.annoCtx.graphics.drawText({
                x: d + t.label.offsetX,
        ...
        key: "_getY1Y2", value: function (t, e) {
            var i, a, s, r, n = "y1" === t ? e.y : e.y2, o = this.w;
    ...
    var t, L, T = {
        ...
        key: "drawShapeAnnos", value: function () {
            var i = this;
        ...
        key: "addText", value: function (t, e) {
            var i = t.x, a = t.y, s = t.text, r = t.textAnchor, n = t.foreColor, o = t.fontSize, l = t.fontFamily,
                ...
                m = t.paddingLeft, v = void 0 === m ? 4 : m, y = t.paddingRight, w = void 0 === y ? 4 : y,
                k = t.paddingBottom, A = void 0 === k ? 2 : k, S = t.paddingTop, C = void 0 === S ? 2 : S, L = this.w,
        ...
        key: "addShape", value: function (t, e) {
            var i = {
                type: t.type,
                x: t.x || 0,
                y: t.y || 0,
        ...
        key: "addAnnotationExternal", value: function (t) {
            var e = t.params, i = t.pushToMemory, a = t.context, s = t.type, r = t.contextMethod, n = a, o = n.w,
                ...
                h = l.childNodes.length + 1, c = new z,
        ...
        key: "removeAnnotation", value: function (t, i) {
            var a = t.w, e = a.globals.dom.baseEl.querySelectorAll(".".concat(i));
        ...
        key: "fillPath", value: function (t) {
            ...
            var o, l, h = this.getFillType(this.seriesIndex),
                c = Array.isArray(r.fill.opacity) ? r.fill.opacity[this.seriesIndex] : r.fill.opacity, d = n;
        ...
        key: "handlePatternFill", value: function (t, e, i, a) {
            var s = this.w.config, r = this.opts, n = new Y(this.ctx),
        ...
        key: "handleGradientFill", value: function (t, e, i) {
            var a = this.w.config, s = this.opts, r = new Y(this.ctx), n = new I, o = a.fill.gradient.type, l = t,
        ...
        key: "plotChartMarkers", value: function (t, e, i, a) {
            var s, r = 4 < arguments.length && void 0 !== arguments[4] && arguments[4], n = this.w, o = e, l = t,
                h = null, c = new Y(this.ctx);
            if ((0 < n.globals.markers.size[e] || r) && (h = c.group({class: r ? "" : "apexcharts-series-markers"})).attr("clip-path", "url(#gridRectMarkerMask".concat(n.globals.cuid, ")")), l.x instanceof Array) for (var d = 0; d < l.x.length; d++) {
                var g, u = 1 === i && 1 === d ? 1 : 1 === i && 0 === d ? 0 : i, p = "apexcharts-marker";
        ...
        key: "draw", value: function (t, e, i) {
            var a = this.w, s = new Y(this.ctx), r = i.realIndex, n = i.pointsPos, o = i.zRatio, l = i.elParent,
            ...
            if (h.attr("clip-path", "url(#gridRectMarkerMask".concat(a.globals.cuid, ")")), n.x instanceof Array) for (var c = 0; c < n.x.length; c++) {
                ...
                var u, p = 0, f = a.globals.markers.size[r];
        ...
        key: "drawPoint", value: function (t, e, i, a, s, r, n) {
            var o, l, h = this.w, c = s, d = new X(this.ctx), g = new E(this.ctx), u = new R(this.ctx),
                p = new D(this.ctx), f = new Y(this.ctx), x = p.getMarkerConfig("apexcharts-marker", c),
                b = u.fillPath({
                    seriesNumber: s,
                    dataPointIndex: r,
            ...
            if (h.config.series[c].data[r] && h.config.series[c].data[r].fillColor && (b = h.config.series[c].data[r].fillColor), m.attr({
            ...
            })), h.globals.dataChanged) if (this.dynamicAnim) {
                ...
                0 === t && 0 === e && (a = 0), d.animateCircle(m, {cx: v, cy: y, r: w}, {
                    cx: t,
                    cy: e,
                    r: a
                }, A, h.globals.easing)
        ...
        key: "dataLabelsCorrection", value: function (t, e, i, a, s, r, n) {
            var o = this.w, l = !1, h = new Y(this.ctx).getTextRects(i, n), c = h.width, d = h.height;
        ...
        key: "drawDataLabel", value: function (t, e, i) {
            var a = this, s = 4 < arguments.length && void 0 !== arguments[4] ? arguments[4] : 2, r = this.w,
                n = new Y(this.ctx), o = r.config.dataLabels, l = 0, h = i, c = null;
        ...
        key: "plotDataLabelsText", value: function (t) {
            var e, i, a, s, r, n, o = this.w, l = new Y(this.ctx), h = t.x, c = t.y, d = t.i, g = t.j, u = t.text,
                p = t.textAnchor, f = t.parent, x = t.dataLabelsConfig, b = t.color, m = t.alwaysDrawDataLabel,
        ...
        key: "dataLabelsBackground", value: function () {
            ...
            if ("bubble" !== t.config.chart.type) for (var e = t.globals.dom.baseEl.querySelectorAll(".apexcharts-datalabels text"), i = 0; i < e.length; i++) {
                var a, s = e[i], r = s.getBBox(), n = null;
                r.width && r.height && (n = this.addBackgroundToDataLabel(s, r)), n && (s.parentNode.insertBefore(n.node, s), a = s.getAttribute("fill"), !t.config.chart.animations.enabled || t.globals.resized || t.globals.dataChanged ? n.attr({fill: a}) : n.animate().attr({fill: a}), s.setAttribute("fill", t.config.dataLabels.background.foreColor))
            }
        }
    }, {
        ...
        key: "handleBarDataLabels", value: function (t) {
            var e = t.x, i = t.y, a = t.y1, s = t.y2, r = t.i, n = t.j, o = t.realIndex, l = t.series, h = t.barHeight,
            ...
            var A, S = w.offsetX, C = w.offsetY, L = {width: 0, height: 0};
        ...
        key: "calculateColumnsDataLabelsPosition", value: function (t) {
            var e = this.w, i = t.i, a = t.j, s = t.y, r = t.bcx, n = t.barWidth, o = t.barHeight, l = t.textRects,
                h = t.dataLabelsY, c = t.barDataLabelsConfig, d = t.strokeWidth, g = t.offX, u = t.offY,
                o = Math.abs(o), p = "vertical" === e.config.plotOptions.bar.dataLabels.orientation;
            r -= d / 2;
            var f = e.globals.gridWidth / e.globals.dataPoints,
                x = e.globals.isXNumeric ? r - n / 2 + g : r - f + n / 2 + g;
            p && (x = x + l.height / 2 - d / 2 - 2);
            var b = this.barCtx.series[i][a] < 0, m = s;
        ...
        key: "calculateBarsDataLabelsPosition", value: function (t) {
            var e = this.w, i = t.x, a = t.i, s = t.j, r = t.bcy, n = t.barHeight, o = t.barWidth, l = t.textRects,
                ...
                p = e.globals.gridHeight / e.globals.dataPoints, o = Math.abs(o),
        ...
        key: "drawCalculatedDataLabels", value: function (t) {
            ...
            var g, u, p, f, x = new N(this.barCtx.ctx), b = new Y(this.barCtx.ctx), m = h.formatter, v = null,
        ...
        key: "highlightRangeInSeries", value: function (t, e) {
            ...
            var a, s = this, r = this.w, n = r.globals.dom.baseEl.getElementsByClassName("apexcharts-heatmap-rect");
        ...
        key: "getActiveConfigSeriesIndex", value: function () {
            var a = 0 < arguments.length && void 0 !== arguments[0] && arguments[0], s = this.w, t = 0;
            if (1 < s.config.series.length) for (var e = s.config.series.map(function (t, e) {
                var i = !1;
                return a && (i = "bar" === s.config.series[e].type || "column" === s.config.series[e].type), t.data && 0 < t.data.length && !i ? e : -1
            }), i = 0; i < e.length; i++) if (-1 !== e[i]) {
                t = e[i];
                break
            }
            return t
        ...
        key: "getPreviousPaths", value: function () {
            ...
            o.globals.previousPaths = [], ["line", "area", "bar", "candlestick", "radar"].forEach(function (t) {
                for (var e = o.globals.dom.baseEl.querySelectorAll(".apexcharts-".concat(t, "-series .apexcharts-series")), i = 0; i < e.length; i++) !function (t, e, i) {
                    ...
                    }, n = 0; n < s.length; n++) s[n].hasAttribute("pathTo") && (a = s[n].getAttribute("pathTo"), r.paths.push({d: a}));
            ...
            if (0 < t.length) for (var e = 0; e < t.length; e++) {
                for (var i = o.globals.dom.baseEl.querySelectorAll(".apexcharts-heatmap .apexcharts-series[data\\:realIndex='".concat(e, "'] rect")), a = [], s = 0; s < i.length; s++) a.push({color: i[s].getAttribute("color")});
        ...
        key: "handleNoData", value: function () {
            var t, e = this.w, i = e.config.noData, a = new Y(this.ctx), s = e.globals.svgWidth / 2,
                r = e.globals.svgHeight / 2, n = "middle";
        ...
        key: "initialPositions", value: function () {
            var t, e, i, a, s, r, n, o, l, h = this.w, c = h.globals.dataPoints;
        ...
        key: "getPathFillColor", value: function (e, i, a, t) {
            var s = this.w, r = new R(this.barCtx.ctx), n = null, o = this.barCtx.barOptions.distributed ? a : i;
        ...
        key: "barBackground", value: function (t) {
            var e, i, a = t.j, s = t.i, r = t.x1, n = t.x2, o = t.y1, l = t.y2, h = t.elSeries, c = this.w,
                d = new Y(this.barCtx.ctx), g = new W(this.barCtx.ctx).getActiveConfigSeriesIndex();
        ...
        key: "getColumnPaths", value: function (t) {
            var e = t.barWidth, i = t.barXPosition, a = t.yRatio, s = t.y1, r = t.y2, n = t.strokeWidth, o = t.series,
                l = t.realIndex, h = t.i, c = t.j, d = t.w, g = new Y(this.barCtx.ctx);
            (n = Array.isArray(n) ? n[l] : n) || (n = 0);
            var u = {barWidth: e, strokeWidth: n, yRatio: a, barXPosition: i, y1: s, y2: r},
                p = this.getRoundedBars(d, u, o, h, c), f = i, x = i + e, b = g.move(f, p.y1), m = g.move(f, p.y1);
        ...
        key: "getBarpaths", value: function (t) {
            var e = t.barYPosition, i = t.barHeight, a = t.x1, s = t.x2, r = t.strokeWidth, n = t.series,
                o = t.realIndex, l = t.i, h = t.j, c = t.w, d = new Y(this.barCtx.ctx);
            (r = Array.isArray(r) ? r[o] : r) || (r = 0);
            var g = {barHeight: i, strokeWidth: r, barYPosition: e, x2: s, x1: a},
                u = this.getRoundedBars(c, g, n, l, h), p = d.move(u.x1, e), f = d.move(u.x1, e);
        ...
        key: "getRoundedBars", value: function (t, e, i, a, s) {
            ...
            var u = null, p = "", f = e.y2, x = e.y1;
            if (void 0 !== i[a][s] || null !== i[a][s]) {
                var b = i[a][s] < 0, m = e.barWidth / 2 - n;
        ...
        key: "draw", value: function (t, e) {
            var i = this.w, a = new Y(this.ctx), s = new P(this.ctx, i);
            ...
            for (var n = 0, o = 0; n < t.length; n++, o++) {
                var l = void 0, h = void 0, c = [], d = [], g = i.globals.comboCharts ? e[n] : n, u = a.group({
                ...
                for (var w = a.group({
                    ...
                    var A = this.barHelpers.getStrokeWidth(n, k, g), S = null,
                        C = {indexes: {i: n, j: k, realIndex: g, bc: o}, x: l, y: h, strokeWidth: A, elSeries: u};
        ...
        key: "renderSeries", value: function (t) {
            var e = t.realIndex, i = t.pathFill, a = t.lineFill, s = t.j, r = t.i, n = t.pathFrom, o = t.pathTo,
                ...
                x = t.barWidth, b = t.barYPosition, m = t.elDataLabelsWrap, v = t.visibleSeries, y = t.type, w = this.w,
                k = new Y(this.ctx),
        ...
        key: "drawColumnPaths", value: function (t) {
            var e, i = t.indexes, a = t.x, s = t.y, r = t.xDivision, n = t.barWidth, o = t.zeroH, l = t.strokeWidth,
                h = t.elSeries, c = this.w, d = i.i, g = i.j, u = i.bc;
            ...
            return c.globals.isXNumeric || (a += r), this.barHelpers.barBackground({
                ...
                elSeries: h
            }), {pathTo: f.pathTo, pathFrom: f.pathFrom, x: a, y: s, barXPosition: p}
        }
    }, {
        ...
        key: "formatDate", value: function (t, e) {
            var i = this.w.globals.locale, a = this.w.config.xaxis.labels.datetimeUTC, s = ["\0"].concat(A(i.months)),
                r = [""].concat(A(i.shortMonths)), n = [""].concat(A(i.days)), o = [""].concat(A(i.shortDays));
            ...
            var g = a ? t.getUTCHours() : t.getHours(), u = 12 < g ? g - 12 : 0 === g ? 12 : g;
            ...
            var v, y = -t.getTimezoneOffset(), w = a || !y ? "Z" : 0 < y ? "+" : "-";
        ...
        return n(e, [{
            key: "draw", value: function (t, e) {
                ...
                for (var s = a.group({class: "apexcharts-rangebar-series apexcharts-plot-series"}), r = 0; r < t.length; r++) {
                    var n = void 0, o = void 0, l = i.globals.comboCharts ? e[r] : r, h = a.group({
                        class: "apexcharts-series",
                    ...
                    for (var g = this.barHelpers.initialPositions(), o = g.y, u = g.zeroW, n = g.x, d = g.barWidth, p = g.xDivision, f = g.zeroH, x = a.group({
                        ...
                        var m = this.barHelpers.getStrokeWidth(r, b, l), v = this.seriesRangeStart[r][b],
                            y = this.seriesRangeEnd[r][b], w = null, k = null,
                            A = {x: n, y: o, strokeWidth: m, elSeries: h}, S = g.yDivision;
                        if (c = g.barHeight, this.isHorizontal) {
                            ...
                            this.isTimelineBar && i.config.series[r].data[b].x && (c = (C = this.detectOverlappingBars({
                                ...
                                indexes: {
                                    ...
                                    j: b,
                                    realIndex: l
                                }, barHeight: c, barYPosition: k, zeroW: u, yDivision: S, y1: v, y2: y
                            }, A))).barWidth
                        ...
                        o = w.y, n = w.x;
                        var P = this.barHelpers.getPathFillColor(t, r, b, l), T = i.globals.stroke.colors[l];
                        this.renderSeries({
                            realIndex: l,
                            pathFill: P,
                            lineFill: T,
            ...
            key: "getTooltipValues", value: function (t) {
                ...
                var p, f = "", x = "", b = n.globals.colors[i];
        ...
        key: "init", value: function (t) {
            var e = t.responsiveOverride, i = this.opts, a = new z, s = new j(i);
            this.chartType = i.chart.type, "histogram" === this.chartType && (i.chart.type = "bar", i = I.extend({plotOptions: {bar: {columnWidth: "99.99%"}}}, i)), i = this.extendYAxis(i), i = this.extendAnnotations(i);
            var r, n = a.init(), o = {};
            ...
            var l = I.extend(o, window.Apex), n = I.extend(l, i);
            return this.handleUserInputErrors(n)
        }
    }, {
        key: "checkForCatToNumericXAxis", value: function (t, e, i) {
            var a = new j(i), s = "bar" === t && i.plotOptions && i.plotOptions.bar && i.plotOptions.bar.horizontal,
        ...
        key: "extendYAxis", value: function (a, t) {
            var s = new z;
        ...
        key: "handleFormatXY", value: function (t, e) {
            ...
            -1 < a.collapsedSeriesIndices.indexOf(e) && (r = this.activeSeriesIndex), i.xaxis.sorted && ("datetime" === i.xaxis.type ? t[e].data.sort(function (t, e) {
            ...
            for (var o = 0; o < t[r].data.length; o++) {
                var l, h = "string" == typeof t[r].data[o].x, c = Array.isArray(t[r].data[o].x),
        ...
        key: "handleRangeDataFormat", value: function (t, r, n) {
            var o = [], l = [], h = r[n].data.filter(function (e, t, i) {
            ...
            if ("array" === t) {
                ...
                for (var s = 0; s < r[n].data.length; s++) !function (t) {
                    var e = I.randomId(), i = r[n].data[t].x,
                        a = {y1: r[n].data[t].y[0], y2: r[n].data[t].y[1], rangeName: e};
        ...
        key: "parseData", value: function (t) {
            var e, i = this.w, a = i.config, s = i.globals;
            ...
            for (var r = this.coreUtils.getCategoryLabels(s.labels), n = 0; n < r.length; n++) if (Array.isArray(r[n])) {
                s.isMultiLineX = !0;
                break
            }
        }
        ...
        key: "getLabel", value: function (t, e, i, a) {
            var s, r, n = 4 < arguments.length && void 0 !== arguments[4] ? arguments[4] : [],
                o = 5 < arguments.length && void 0 !== arguments[5] ? arguments[5] : "12px", l = this.w,
                h = void 0 === t[a] ? "" : t[a], c = h, d = l.globals.xLabelFormatter,
                g = l.config.xaxis.labels.formatter, u = !1, c = new J(this.ctx).xLabelFormat(d, h, h);
        ...
        key: "drawYAxisTicks", value: function (t, e, i, a, s, r, n) {
            var o = this.w, l = new Y(this.ctx), h = o.globals.translateY;
            if (a.show && 0 < e) {
        ...
        key: "dataURI", value: function () {
            ...
            return new Promise(function (i) {
                ...
                window.canvg && I.isIE11() ? ((r = window.canvg.Canvg.fromString(s, h, {
                    ignoreClear: !0,
                    ignoreDimensions: !0
                })).start(), n = a.msToBlob(), r.stop(), i({blob: n})) : (o = "data:image/svg+xml," + encodeURIComponent(h), (l = new Image).crossOrigin = "anonymous", l.onload = function () {
                    var t, e;
                    s.drawImage(l, 0, 0), a.msToBlob ? (t = a.msToBlob(), i({blob: t})) : (e = a.toDataURL("image/png"), i({imgURI: e}))
                }, l.src = o)
            })
        }
    }, {
        ...
        key: "exportToPng", value: function () {
            ...
            this.dataURI().then(function (t) {
                var e = t.imgURI, i = t.blob;
                i ? navigator.msSaveOrOpenBlob(i, a.w.globals.chartID + ".png") : a.triggerDownload(e, null, ".png")
            })
        }
    }, {
        key: "exportToCSV", value: function (t) {
            var h = this, c = t.series, d = t.columnDelimiter, e = t.lineDelimiter, i = void 0 === e ? "\n" : e,
                g = this.w, u = [], p = [], a = "data:text/csv;charset=utf-8,", f = new $(this.ctx),
                x = new Q(this.ctx);
            u.push(g.config.chart.toolbar.export.csv.headerCategory), c.map(function (t, e) {
                ...
                g.globals.axisCharts ? function (t, e) {
                    if (u.length && 0 === e && p.push(u.join(d)), t.data && t.data.length) for (var i = 0; i < t.data.length; i++) {
                        u = [];
        ...
        key: "drawXaxis", value: function () {
            var n = this, o = this.w, l = new Y(this.ctx), t = l.group({
            ...
            if (c = o.globals.isXNumeric ? (i = 1 < p ? p - 1 : p, g = o.globals.gridWidth / i, c + g / 2 + o.config.xaxis.labels.offsetX) : (g = o.globals.gridWidth / d.length, c + g + o.config.xaxis.labels.offsetX), o.config.xaxis.labels.show) for (var f = 0; f <= p - 1; f++) !function (t) {
            ...
            return void 0 !== o.config.xaxis.title.text && (a = l.group({class: "apexcharts-xaxis-title"}), s = l.drawText({
        ...
        key: "drawXaxisInversed", value: function (t) {
            var e, i, a = this.w, s = new Y(this.ctx),
            ...
            var c, d, g = a.globals.yLabelFormatters[0], u = a.config.yaxis[0].labels;
            if (u.show) for (var p = 0; p <= l.length - 1; p++) {
                var f = g(f = void 0 === l[p] ? "" : l[p], {seriesIndex: t, dataPointIndex: p, w: a}), x = 0;
        ...
        key: "getXAxisTicksPositions", value: function () {
            ...
            if (0 < t.globals.timescaleLabels.length) for (var s = 0; s < i; s++) a = this.xaxisLabels[s].position, e.push(a); else for (var r = i, n = 0; n < r; n++) {
                var o = r;
        ...
        key: "xAxisLabelCorrections", value: function () {
            var a = this.w, s = new Y(this.ctx), t = a.globals.dom.baseEl.querySelector(".apexcharts-xaxis-texts-g"),
            ...
            if (a.globals.rotateXLabels || a.config.xaxis.labels.rotateAlways) for (var n = 0; n < r.length; n++) {
            ...
            if (0 < e.length) {
                var h = e[e.length - 1].getBBox(), c = e[0].getBBox();
        ...
        key: "createGridMask", value: function () {
            var e, t = this.w, i = t.globals, a = new Y(this.ctx),
        ...
        key: "_drawGridBandRect", value: function (t) {
            var e, i, a = t.c, s = t.x1, r = t.y1, n = t.x2, o = t.y2, l = t.type, h = this.w, c = new Y(this.ctx),
        ...
        key: "_drawXYLines", value: function (t) {
            var e, i, o = this, l = t.xCount, a = t.tickAmount, h = this.w;
            ...
            }({xC: l, x1: e, y1: 0, x2: void 0, y2: i}))), h.config.grid.yaxis.lines.show) {
                var s = 0, r = 0, n = h.globals.gridWidth, c = a + 1;
        ...
        key: "drawGridBands", value: function (t, e) {
            var i = this.w;
            if (void 0 !== i.config.grid.row.colors && 0 < i.config.grid.row.colors.length) for (var a = 0, s = i.globals.gridHeight / e, r = i.globals.gridWidth, n = 0, o = 0; n < e; n++, o++) o >= i.config.grid.row.colors.length && (o = 0), this._drawGridBandRect({
                c: o,
                x1: 0,
                y1: a,
                x2: r,
        ...
        key: "niceScale", value: function (t, e) {
            var i = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 10,
                a = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : 0,
                s = 4 < arguments.length ? arguments[4] : void 0, r = this.w;
            ...
            var l = i + 1;
            l < 2 ? l = 2 : 2 < l && (l -= 2);
            var h = o / l, c = Math.floor(I.log10(h)), d = Math.pow(10, c), g = Math.round(h / d);
            g < 1 && (g = 1);
            var u = g * d, p = u * Math.floor(t / u), f = u * Math.ceil(e / u), x = p;
            if (s && 2 < o) {
                for (; n.push(x), !((x += u) > f);) ;
        ...
        key: "linearScale", value: function (t, e) {
            var i = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 10, a = Math.abs(e - t) / i;
            i === Number.MAX_VALUE && (i = 10, a = 1);
            for (var s = [], r = t; 0 <= i;) s.push(r), r += a, --i;
            return {result: s, niceMin: s[0], niceMax: s[s.length - 1]}
        }
    }, {
        key: "logarithmicScale", value: function (t, s, r, e) {
            ...
            var h = a.map(function (t, e) {
                t <= 0 && (t = .01);
                var i = (o - n) / (r - s), a = Math.pow(10, n + i * (t - n));
        ...
        key: "setMultipleYScales", value: function () {
            var r = this, t = this.w.globals, n = this.w.config, o = t.minYArr.concat([]), l = t.maxYArr.concat([]),
                h = [];
        ...
        key: "sameScaleInMultipleAxes", value: function (t, s, e) {
            var o = this, l = this.w.config, h = this.w.globals, r = [];
        ...
        key: "autoScaleY", value: function (t, c, d) {
            ...
            return c.forEach(function (a, t) {
                ...
                var n, o, r = g.globals.minYArr[t], l = g.globals.maxYArr[t], h = g.globals.stackedSeriesTotals;
        ...
        key: "setXRange", value: function () {
            ...
            if (i.isXNumeric && function () {
                for (var t = 0; t < i.series.length; t++) if (i.labels[t]) for (var e = 0; e < i.labels[t].length; e++) null !== i.labels[t][e] && I.isNumber(i.labels[t][e]) && (i.maxX = Math.max(i.maxX, i.labels[t][e]), i.initialMaxX = Math.max(i.maxX, i.labels[t][e]), i.minX = Math.min(i.minX, i.labels[t][e]), i.initialMinX = Math.min(i.minX, i.labels[t][e]))
                ...
                if (void 0 === e.xaxis.tickAmount ? (t = Math.round(i.svgWidth / 150), "numeric" === e.xaxis.type && i.dataPoints < 30 && (t = i.dataPoints - 1), t > i.dataPoints && 0 !== i.dataPoints && (t = i.dataPoints - 1)) : "dataPoints" === e.xaxis.tickAmount ? (1 < i.series.length && (t = i.series[i.maxValsInArrayIndex].length - 1), i.isXNumeric && (t = i.maxX - i.minX - 1)) : t = e.xaxis.tickAmount, i.xTickAmount = t, void 0 !== e.xaxis.max && "number" == typeof e.xaxis.max && (i.maxX = e.xaxis.max), void 0 !== e.xaxis.min && "number" == typeof e.xaxis.min && (i.minX = e.xaxis.min), void 0 !== e.xaxis.range && (i.minX = i.maxX - e.xaxis.range), i.minX !== Number.MAX_VALUE && i.maxX !== -Number.MAX_VALUE) if (e.xaxis.convertedCatToNumeric && !i.dataFormatXNumeric) {
        ...
        key: "setZRange", value: function () {
            ...
            if (t.isDataXYZ) for (var e = 0; e < t.series.length; e++) if (void 0 !== t.seriesZ[e]) for (var i = 0; i < t.seriesZ[e].length; i++) null !== t.seriesZ[e][i] && I.isNumber(t.seriesZ[e][i]) && (t.maxZ = Math.max(t.maxZ, t.seriesZ[e][i]), t.minZ = Math.min(t.minZ, t.seriesZ[e][i]))
        }
    }, {
        key: "_handleSingleDataPoint", value: function () {
            var t, e, i, a = this.w.globals, s = this.w.config;
        ...
        key: "_setStackedMinMax", value: function () {
            ...
            if (t.series.length) for (var a = 0; a < t.series[t.maxValsInArrayIndex].length; a++) for (var s = 0, r = 0, n = 0; n < t.series.length; n++) null !== t.series[n][a] && I.isNumber(t.series[n][a]) && (0 < t.series[n][a] ? s = s + parseFloat(t.series[n][a]) + 1e-4 : r += parseFloat(t.series[n][a])), n === t.series.length - 1 && (e.push(s), i.push(r));
            for (var o = 0; o < e.length; o++) t.maxY = Math.max(t.maxY, e[o]), t.minY = Math.min(t.minY, i[o])
        }
    }]), me), st = (n(be, [{
        key: "drawYaxis", value: function (n) {
            var o = this.w, l = new Y(this.ctx), h = o.config.yaxis[n].labels.style, c = h.fontSize, d = h.fontFamily,
                g = h.fontWeight, t = l.group({
            ...
            t.add(u);
            var e, i, a, p = o.globals.yAxisScale[n].result.length - 1, f = o.globals.gridHeight / p,
                x = o.globals.translateY, b = o.globals.yLabelFormatters[n], m = o.globals.yAxisScale[n].result.slice(),
                m = this.axesUtils.checkForReversedLabels(n, m), v = "";
            if (o.config.yaxis[n].labels.show) for (var s = p; 0 <= s; s--) !function (t) {
                var e = m[t], e = b(e, t), i = o.config.yaxis[n].labels.padding;
            ...
            void 0 !== o.config.yaxis[n].title.text && (e = l.group({class: "apexcharts-yaxis-title"}), i = 0, o.config.yaxis[n].opposite && (i = o.globals.translateYAxisX[n]), a = l.drawText({
                x: i,
            ...
            var r, y = o.config.yaxis[n].axisBorder, w = 31 + y.offsetX;
        ...
        key: "drawYaxisInversed", value: function (t) {
            var e = this.w, i = new Y(this.ctx), a = i.group({class: "apexcharts-xaxis apexcharts-yaxis-inversed"}),
                s = i.group({
                    class: "apexcharts-xaxis-texts-g",
            ...
            var d = c.length;
            if (e.config.xaxis.labels.show) for (var g = d ? 0 : r; d ? g < d : 0 <= g; d ? g++ : g--) {
                var u = h[g];
                u = l(u, g);
        ...
        key: "inversedYAxisBorder", value: function (t) {
            var e, i, a = this.w, s = new Y(this.ctx), r = a.config.xaxis.axisBorder;
        ...
        key: "inversedYAxisTitleText", value: function (t) {
            var e, i, a = this.w, s = new Y(this.ctx);
            void 0 !== a.config.xaxis.title.text && (e = s.group({class: "apexcharts-xaxis-title apexcharts-yaxis-title-inversed"}), i = s.drawText({
        ...
        key: "yAxisTitleRotate", value: function (t, e) {
            var i = this.w, a = new Y(this.ctx), s = {width: 0, height: 0}, r = {width: 0, height: 0},
        ...
        key: "setYAxisXPosition", value: function (s, r) {
            var n, o = this.w, l = 0, h = 18, c = 1;
        ...
        key: "setYAxisTextAlignments", value: function () {
            var n = this.w, t = n.globals.dom.baseEl.getElementsByClassName("apexcharts-yaxis");
        ...
        key: "documentEvent", value: function (e) {
            var t, i, a = this.w, s = e.target.className;
        ...
        key: "drawAxis", value: function (t, e) {
            var i, a, s = this.w.globals, r = this.w.config, n = new tt(this.ctx), o = new st(this.ctx);
        ...
        key: "drawXCrosshairs", value: function () {
            var t, e = this.w, i = new Y(this.ctx), a = new E(this.ctx), s = e.config.xaxis.crosshairs.fill.gradient,
                r = e.config.xaxis.crosshairs.dropShadow, n = e.config.xaxis.crosshairs.fill.type, o = s.colorFrom,
                l = s.colorTo, h = s.opacityFrom, c = s.opacityTo, d = s.stops, g = r.enabled, u = r.left, p = r.top,
                f = r.blur, x = r.color, b = r.opacity, m = e.config.xaxis.crosshairs.fill.color;
        ...
        key: "drawYCrosshairs", value: function () {
            var t, e = this.w, i = new Y(this.ctx), a = e.config.yaxis[0].crosshairs,
        ...
        key: "checkResponsiveConfig", value: function (t) {
            var r, n, e, i, o = this, l = this.w, a = l.config;
            0 !== a.responsive.length && ((r = a.responsive.slice()).sort(function (t, e) {
                return t.breakpoint > e.breakpoint ? 1 : e.breakpoint > t.breakpoint ? -1 : 0
            }).reverse(), n = new U({}), e = function () {
                var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}, e = r[0].breakpoint,
                    i = 0 < window.innerWidth ? window.innerWidth : screen.width;
                if (e < i) {
                    var a = P.extendArrayProps(n, l.globals.initialConfig, l), t = I.extend(a, t);
                    t = I.extend(l.config, t), o.overrideResponsiveOptions(t)
                } else for (var s = 0; s < r.length; s++) i < r[s].breakpoint && (t = P.extendArrayProps(n, r[s].options, l), t = I.extend(l.config, t), o.overrideResponsiveOptions(t))
        ...
        key: "setDefaultColors", value: function () {
            ...
            if (s.globals.dom.elWrap.classList.add("apexcharts-theme-".concat(s.config.theme.mode)), void 0 === s.config.colors ? s.globals.colors = this.predefined() : (s.globals.colors = s.config.colors, Array.isArray(s.config.colors) && 0 < s.config.colors.length && "function" == typeof s.config.colors[0] && (s.globals.colors = s.config.series.map(function (t, e) {
                ...
                for (var r = s.config.theme.monochrome.color, n = 1 / (i / s.config.theme.monochrome.shadeIntensity), o = s.config.theme.monochrome.shadeTo, l = 0, h = 0; h < i; h++) {
                    var c = void 0, c = "dark" === o ? t.shadeColor(-1 * l, r) : t.shadeColor(l, r);
                    l += n, e.push(c)
                }
        ...
        key: "drawTitleSubtitle", value: function (t) {
            var e, i = this.w, a = "title" === t ? i.config.title : i.config.subtitle, s = i.globals.svgWidth / 2,
                r = a.offsetY, n = "middle";
        ...
        key: "getTitleSubtitleCoords", value: function (t) {
            var e, i = this.w, a = 0, s = 0, r = "title" === t ? i.config.title.floating : i.config.subtitle.floating,
        ...
        key: "getxAxisLabelsCoords", value: function () {
            var t, e, i, a, s, r, n, o, l, h, c, d = this.w, g = d.globals.labels.slice();
        ...
        key: "additionalPaddingXLabels", value: function (t) {
            var n = this, o = this.w, l = o.globals, h = o.config, c = h.xaxis.type, d = t.width;
        ...
        key: "getyAxisLabelsCoords", value: function () {
            var d = this, g = this.w, u = [], p = 10, f = new Q(this.dCtx.ctx);
        ...
        key: "getTotalYAxisWidth", value: function () {
            ...
            var s = this.w, r = 0, n = 0, o = 0, l = 1 < s.globals.yAxisScale.length ? 10 : 0, h = new Q(this.dCtx.ctx);
        ...
        key: "gridPadForColumnsInNumericAxis", value: function (t) {
            ...
            var i, a, s, r = e.config.chart.type, n = 0,
        ...
        key: "setGridXPosForDualYAxis", value: function (i, a) {
            var s = this.w, r = new Q(this.dCtx.ctx);
        ...
        key: "hideSeries", value: function (t) {
            var e, i, a = t.seriesEl, s = t.realIndex, r = this.w, n = I.clone(r.config.series);
        ...
        key: "riseCollapsedSeries", value: function (t, e, i) {
            var a = this.w, s = I.clone(a.config.series);
            if (0 < t.length) {
        ...
        key: "drawLegends", value: function () {
            ...
            for (var r = e.globals.legendFormatter, n = e.config.legend.inverseOrder, o = n ? a.length - 1 : 0; n ? 0 <= o : o <= a.length - 1; n ? o-- : o++) {
                var l = r(a[o], {seriesIndex: o, w: e}), h = !1, c = !1;
                if (0 < e.globals.collapsedSeries.length) for (var d = 0; d < e.globals.collapsedSeries.length; d++) e.globals.collapsedSeries[d].index === o && (h = !0);
                if (0 < e.globals.ancillaryCollapsedSeriesIndices.length) for (var g = 0; g < e.globals.ancillaryCollapsedSeriesIndices.length; g++) e.globals.ancillaryCollapsedSeriesIndices[g] === o && (c = !0);
        ...
        key: "setLegendWrapXY", value: function (t, e) {
            var i, a, s, r, n = this.w, o = n.globals.dom.baseEl.querySelector(".apexcharts-legend"),
                l = o.getBoundingClientRect(), h = 0;
        ...
        key: "legendAlignHorizontal", value: function () {
            ...
            var e = this.legendHelpers.getLegendBBox(), i = new xt(this.ctx),
        ...
        key: "createToolbar", value: function () {
            ...
            var s = this, r = this.w, e = t();
            if (e.setAttribute("class", "apexcharts-toolbar"), e.style.top = r.config.chart.toolbar.offsetY + "px", e.style.right = 3 - r.config.chart.toolbar.offsetX + "px", r.globals.dom.elWrap.appendChild(e), this.elZoom = t(), this.elZoomIn = t(), this.elZoomOut = t(), this.elPan = t(), this.elSelection = t(), this.elZoomReset = t(), this.elMenuIcon = t(), this.elMenu = t(), this.elCustomIcons = [], this.t = r.config.chart.toolbar.tools, Array.isArray(this.t.customIcons)) for (var i = 0; i < this.t.customIcons.length; i++) this.elCustomIcons.push(t());
        ...
        key: "zoomUpdateOptions", value: function (t, e) {
            ...
            void 0 !== t || void 0 !== e ? n.config.xaxis.convertedCatToNumeric && (t < 1 && (t = 1, e = n.globals.dataPoints), e - t < 2) || (i = {
                min: t,
                max: e
            }, (a = this.getBeforeZoomRange(i)) && (i = a.xaxis), s = {xaxis: i}, r = I.clone(n.globals.initialConfig.yaxis), n.config.chart.zoom.autoScaleYaxis && (r = new it(this.ctx).autoScaleY(this.ctx, r, {xaxis: i})), n.config.chart.group || (s.yaxis = r), this.w.globals.zoomed = !0, this.ctx.updateHelpers._updateOptions(s, !1, this.w.config.chart.animations.dynamicAnimation.enabled), this.zoomCallback(i, r)) : this.handleZoomReset()
        }
    }, {
        ...
        return n(a, [{
            ...
            key: "svgMouseEvents", value: function (t, e) {
                var i, a, s = this.w, r = this, n = this.ctx.toolbar,
            ...
            key: "preselectedSelection", value: function () {
                var t, e, i = this.w, a = this.xyRatios;
            ...
            key: "drawSelectionRect", value: function (t) {
                var e, i = t.x, a = t.y, s = t.width, r = t.height, n = t.translateX, o = void 0 === n ? 0 : n,
                    l = t.translateY, h = void 0 === l ? 0 : l, c = this.w, d = this.zoomRect, g = this.selectionRect;
                !this.dragged && null === c.globals.selection || (e = {transform: "translate(" + o + ", " + h + ")"}, c.globals.zoomEnabled && this.dragged && (s < 0 && (s = 1), d.attr({
                    x: i,
                    y: a,
                    width: s,
                    height: r,
            ...
            key: "selectionDrawing", value: function (t) {
                var e, i = t.context, a = t.zoomtype, s = this.w, r = i, n = this.gridRect.getBoundingClientRect(),
                    o = r.startX - 1, l = r.startY, h = !1, c = !1, d = r.clientX - n.left - o,
                    g = r.clientY - n.top - l;
                ...
                } : "y" === a ? {x: 0, y: c ? l - g : l, width: s.globals.gridWidth, height: g} : {
                    x: h ? o - d : o,
                    y: c ? l - g : l,
                    width: d,
                    height: g
            ...
            key: "selectionDragging", value: function (t, e) {
                var n = this, o = this.w, l = this.xyRatios, h = this.selectionRect, i = 0;
                "resizing" === t && (i = 30);
                ...
                o.globals.selection = s, "function" == typeof o.config.chart.events.selection && o.globals.selectionEnabled && (clearTimeout(this.w.globals.selectionResizeTimer), this.w.globals.selectionResizeTimer = window.setTimeout(function () {
                    var t = n.gridRect.getBoundingClientRect(), e = h.node.getBoundingClientRect(),
                    ...
                    o.config.chart.events.selection(n.ctx, {xaxis: {min: i, max: a}, yaxis: {min: s, max: r}})
                }, i))
            }
        }, {
            key: "selectionDrawn", value: function (t) {
                var e, i, a = t.context, s = t.zoomtype, r = this.w, n = a, o = this.xyRatios, l = this.ctx.toolbar;
                ...
                var h, c, d, g, u, p, f = r.globals.xAxisScale.niceMin + n.startX * o.xRatio,
                    x = r.globals.xAxisScale.niceMin + n.endX * o.xRatio, b = [], m = [];
                ...
                }), r.config.chart.zoom.autoScaleYaxis && (c = new it(n.ctx).autoScaleY(n.ctx, c, {xaxis: h})), !l || (d = l.getBeforeZoomRange(h, c)) && (h = d.xaxis ? d.xaxis : h, c = d.yaxis ? d.yaxe : c), g = {xaxis: h}, r.config.chart.group || (g.yaxis = c), n.ctx.updateHelpers._updateOptions(g, !1, n.w.config.chart.animations.dynamicAnimation.enabled), "function" == typeof r.config.chart.events.zoomed && l.zoomCallback(h, c)) : r.globals.selectionEnabled && (u = null, p = {
                    min: f,
                    max: x
            ...
            key: "panDragging", value: function (t) {
                var e, i, a = t.context, s = this.w, r = a;
                ...
                var n = s.globals.minX, o = s.globals.maxX;
            ...
            key: "panScrolled", value: function (t, e) {
                var i = this.w, a = this.xyRatios, s = I.clone(i.globals.initialConfig.yaxis);
                ...
                var r = {min: t, max: e};
                i.config.chart.zoom.autoScaleYaxis && (s = new it(this.ctx).autoScaleY(this.ctx, s, {xaxis: r}));
        ...
        key: "closestInMultiArray", value: function (n, o, l, h) {
            var t = this.w, e = 0, c = null, d = -1;
            1 < t.globals.series.length ? e = this.getFirstActiveXArray(l) : c = 0;
            var i = h[e][0], a = l[e][0], s = Math.abs(n - a), r = Math.abs(o - i), g = r + s;
            return h.map(function (t, r) {
                t.map(function (t, e) {
                    var i = Math.abs(o - h[r][e]), a = Math.abs(n - l[r][e]), s = a + i;
                    s < g && (g = s, c = r, d = e)
                })
            }), {index: c, j: d}
        }
        ...
        key: "printLabels", value: function (t) {
            var r, n = this, o = t.i, l = t.j, e = t.values, h = t.ttItems, c = t.shared, d = this.w, g = e.xVal,
                u = e.zVal, p = e.xAxisTTVal, f = "", x = d.globals.colors[o];
            ...
            for (var i = 0, a = d.globals.series.length - 1; i < d.globals.series.length; i++, a--) !function (t, e) {
                ...
                f = n.getSeriesName({fn: i.yLbTitleFormatter, index: o, seriesIndex: o, j: l});
        ...
        key: "DOMHandling", value: function (t) {
            t.i;
            var e = t.t, i = (t.j, t.ttItems), a = t.values, s = t.seriesName, r = t.shared, n = t.pColor, o = this.w,
                l = this.ttCtx, h = a.val, c = a.xVal, d = a.xAxisTTVal, g = a.zVal, u = null, u = i[e].children;
        ...
        key: "getValuesToPrint", value: function (t) {
            var e = t.i, i = t.j, a = this.w, s = this.ctx.series.filteredSeriesX(), r = "", n = "", o = null, l = null,
                h = {series: a.globals.series, seriesIndex: e, dataPointIndex: i, w: a}, c = a.globals.ttZFormatter;
        ...
        key: "moveXCrosshairs", value: function (t) {
            var e, i = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : null, a = this.ttCtx,
                s = this.w, r = a.getElXCrosshairs(), n = t - a.xcrosshairsWidth / 2,
        ...
        key: "moveYCrosshairs", value: function (t) {
            ...
            null !== e.ycrosshairs && Y.setAttrs(e.ycrosshairs, {
                y1: t,
                y2: t
            }), null !== e.ycrosshairsHidden && Y.setAttrs(e.ycrosshairsHidden, {y1: t, y2: t})
        }
    }, {
        key: "moveXAxisTooltip", value: function (t) {
            var e, i, a = this.w, s = this.ttCtx;
        ...
        key: "moveTooltip", value: function (t, e) {
            var i, a, s = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : null, r = this.w,
                n = this.ttCtx, o = n.getElTooltip(), l = n.tooltipRect, h = null !== s ? parseFloat(s) : 1,
                c = parseFloat(t) + h + 5, d = parseFloat(e) + h / 2;
        ...
        key: "moveMarkers", value: function (t, e) {
            ...
            if (0 < i.globals.markers.size[t]) for (var s = i.globals.dom.baseEl.querySelectorAll(" .apexcharts-series[data\\:realIndex='".concat(t, "'] .apexcharts-marker")), r = 0; r < s.length; r++) parseInt(s[r].getAttribute("rel"), 10) === e && (a.marker.resetPointsSize(), a.marker.enlargeCurrentPoint(e, s[r])); else a.marker.resetPointsSize(), this.moveDynamicPointOnHover(e, t)
        }
    }, {
        key: "moveDynamicPointOnHover", value: function (t, e) {
            var i, a, s, r = this.w, n = this.ttCtx, o = r.globals.pointsArray, l = n.tooltipUtil.getHoverMarkerSize(e),
        ...
        key: "moveDynamicPointsOnHover", value: function (t) {
            var e = this.ttCtx, i = e.w, a = 0, s = 0, r = i.globals.pointsArray,
                n = new W(this.ctx).getActiveConfigSeriesIndex(!0), o = e.tooltipUtil.getHoverMarkerSize(n);
            r[n] && (a = r[n][t][0], s = r[n][t][1]);
            var l, h = e.tooltipUtil.getAllMarkers();
            if (null !== h) for (var c = 0; c < i.globals.series.length; c++) {
                var d, g = r[c];
        ...
        key: "moveStickyTooltipOverBars", value: function (t) {
            var e = this.w, i = this.ttCtx,
                ...
                n = r ? parseFloat(r.getAttribute("cx")) : 0, o = r ? parseFloat(r.getAttribute("barWidth")) : 0;
            ...
            var l, h = i.getElGrid().getBoundingClientRect(), c = i.e.clientY - h.top - i.tooltipRect.ttHeight / 2;
            this.moveXCrosshairs(n), i.fixedTooltip || (l = c || e.globals.gridHeight, this.moveTooltip(n, l))
        }
    }]), Kt), St = (n(Qt, [{
        key: "drawDynamicPoints", value: function () {
            var t = this.w, e = new Y(this.ctx), i = new D(this.ctx),
        ...
        key: "enlargeCurrentPoint", value: function (t, e) {
            ...
            var r, n = e.getAttribute("cx"), o = e.getAttribute("cy");
        ...
        key: "enlargePoints", value: function (t) {
            for (var e = this.w, i = this.ttCtx, a = t, s = e.globals.dom.baseEl.querySelectorAll(".apexcharts-series:not(.apexcharts-series-collapsed) .apexcharts-marker"), r = e.config.markers.hover.size, n = 0; n < s.length; n++) {
                var o, l, h = s[n].getAttribute("rel"), c = s[n].getAttribute("index");
        ...
        key: "newPointSize", value: function (t, e) {
            var i, a = this.w, s = a.config.markers.hover.size,
        ...
        key: "handleHeatTooltip", value: function (t) {
            var e, i, a, s, r, n, o, l = t.e, h = t.opt, c = t.x, d = t.y, g = this.ttCtx, u = this.w;
        ...
        key: "handleMarkerTooltip", value: function (t) {
            var e, i, a, s, r, n, o, l = t.e, h = t.opt, c = t.x, d = t.y, g = this.w, u = this.ttCtx;
        ...
        key: "handleBarTooltip", value: function (t) {
            var e, i, a, s, r = t.e, n = t.opt, o = this.w, l = this.ttCtx, h = l.getElTooltip(), c = 0, d = 0, g = 0,
                u = this.getBarTooltipXY({e: r, opt: n}), p = u.i, f = u.barHeight, x = u.j;
        ...
        key: "getBarTooltipXY", value: function (t) {
            var e, i, a, s, r, n, o, l, h, c, d = t.e, g = t.opt, u = this.w, p = null, f = this.ttCtx, x = 0, b = 0,
                m = 0, v = 0, y = 0, w = d.target.classList;
        ...
        key: "setXCrosshairWidth", value: function () {
            var t, e, i, a, s, r, n = this.w, o = this.ttCtx, l = o.getElXCrosshairs();
        ...
        key: "drawYaxisTooltipText", value: function (t, e, i) {
            var a, s, r, n, o = this.ttCtx, l = this.w, h = l.globals.yLabelFormatters[t];
        ...
        key: "drawFixedTooltipRect", value: function () {
            var t = this.w, e = this.getElTooltip(), i = e.getBoundingClientRect(), a = i.width + 10, s = i.height + 10,
                r = this.tConfig.fixed.offsetX, n = this.tConfig.fixed.offsetY,
        ...
        key: "addPathsEventListeners", value: function (a, t) {
            for (var s = this, e = 0; e < a.length; e++) !function (e) {
                ...
                ["mousemove", "mouseup", "touchmove", "mouseout", "touchend"].map(function (t) {
                    return a[e].addEventListener(t, s.seriesHover.bind(s, i), {capture: !1, passive: !0})
                })
            }(e)
        }
    }, {
        key: "seriesHover", value: function (a, s) {
            var r = this, t = [], e = this.w;
            ...
            }) : this.seriesHoverByContext({chartCtx: this.ctx, ttCtx: this.w.globals.tooltip, opt: a, e: s}))
        }
    }, {
        ...
        key: "axisChartsTooltips", value: function (t) {
            ...
            if (this.clientY = n, this.clientX = r, a.globals.capturedSeriesIndex = -1, a.globals.capturedDataPointIndex = -1, n < s.top || n > s.top + s.height) this.handleMouseOut(i); else {
                ...
                var l = this.getElTooltip(), h = this.getElXCrosshairs(),
                ...
                if (a.globals.isBarHorizontal && this.tooltipUtil.hasBars() && (c = !1), "mousemove" === e.type || "touchmove" === e.type || "mouseup" === e.type) {
                    ...
                    if (null !== this.ycrosshairs && p.length && this.ycrosshairs.classList.add("apexcharts-active"), c && !this.showOnIntersect ? this.handleStickyTooltip(e, r, n, i) : "heatmap" === a.config.chart.type ? (g = (d = this.intersect.handleHeatTooltip({
                        ...
                        x: g,
                        y: u
                    })), this.yaxisTooltips.length) for (var f = 0; f < a.config.yaxis.length; f++) this.axesTooltip.drawYaxisTooltipText(f, n, this.xyRatios);
        ...
        key: "nonAxisChartsTooltips", value: function (t) {
            var e, i, a = t.e, s = t.opt, r = t.tooltipRect, n = this.w, o = s.paths.getAttribute("rel"),
                l = this.getElTooltip(), h = n.globals.dom.elWrap.getBoundingClientRect();
        ...
        key: "create", value: function (t, e, i, a, s) {
            var r = 5 < arguments.length && void 0 !== arguments[5] ? arguments[5] : null, n = this.w, o = e;
            ...
            if (r) {
                if (o.tooltipLabels.drawSeriesTexts({
                    ...
                    var b = new Y(this.ctx), m = n.globals.dom.Paper.select(".apexcharts-bar-area[j='".concat(a, "']"));
        ...
        return n(e, [{
            key: "draw", value: function (v, y) {
                ...
                for (var A = this.graphics.group({class: "apexcharts-bar-series apexcharts-plot-series"}), S = 0, C = 0, i = 0, a = 0; i < v.length; i++, a++) !function (t, e) {
                    var i, a, s, r, n = [], o = [], l = k.globals.comboCharts ? y[t] : t;
                    ...
                    var c = w.graphics.group({class: "apexcharts-datalabels", "data:realIndex": l}), d = 0, g = 0,
                    ...
                    for (var p = 0; p < k.globals.dataPoints; p++) {
                        var f = w.barHelpers.getStrokeWidth(t, p, l),
                            x = {indexes: {i: t, j: p, realIndex: l, bc: e}, strokeWidth: f, x: S, y: C, elSeries: h},
                            b = null;
                        ...
                        var m = w.barHelpers.getPathFillColor(v, t, p, l), h = w.renderSeries({
                            realIndex: l,
                            pathFill: m,
                            j: p,
                            i: t,
            ...
            key: "drawStackedBarPaths", value: function (t) {
                ...
                return this.barHelpers.barBackground({
                    ...
                    y2: s,
                    elSeries: c
                }), l += h, {pathTo: b.pathTo, pathFrom: b.pathFrom, x: o, y: l}
            }
        }, {
            key: "drawStackedColumnPaths", value: function (t) {
                ...
                if (0 < h && !l.globals.isXNumeric || 0 < h && l.globals.isXNumeric && l.globals.seriesX[h - 1][c] === l.globals.seriesX[h][c]) {
                    ...
                    if (void 0 !== this.prevY[h - 1]) for (var v = 1; v < m; v++) if (!isNaN(this.prevY[h - v][c])) {
                        b = this.prevY[h - v][c];
                        break
                    }
                    for (var y = 1; y < m; y++) {
                ...
                return this.barHelpers.barBackground({
                    ...
                    x2: r,
                    elSeries: o
                }), i += s, {pathTo: w.pathTo, pathFrom: w.pathFrom, x: l.globals.isXNumeric ? i - s : i, y: a}
            }
        }]), e
    }(), zt = function () {
        l(e, V);
        ...
        return n(e, [{
            key: "draw", value: function (t, e) {
                var i = this.w, a = new Y(this.ctx), s = new R(this.ctx);
                ...
                for (var n = a.group({class: "apexcharts-candlestick-series apexcharts-plot-series"}), o = 0; o < t.length; o++) {
                    var l, h, c, d, g = void 0, u = void 0, p = [], f = [], x = i.globals.comboCharts ? e[o] : o,
                        b = a.group({
                            class: "apexcharts-series",
                    ...
                    for (var v = a.group({
                        ...
                        var w = this.barHelpers.getStrokeWidth(o, y, x), k = this.drawCandleStickPaths({
                            ...
                            strokeWidth: w,
                            elSeries: b
                        }), u = k.y, g = k.x, A = k.color;
                        0 < y && f.push(g + d / 2), p.push(u);
                        var S = s.fillPath({seriesNumber: x, dataPointIndex: y, color: A, value: t[o][y]}),
            ...
            key: "drawCandleStickPaths", value: function (t) {
                var e = t.indexes, i = t.x, a = (t.y, t.xDivision), s = t.barWidth, r = t.zeroH, n = t.strokeWidth,
                    o = this.w, l = new Y(this.ctx), h = e.i, c = e.j, d = !0,
                    g = o.config.plotOptions.candlestick.colors.upward,
                    u = o.config.plotOptions.candlestick.colors.downward, p = this.yRatio[this.yaxisIndex],
                    f = e.realIndex, x = this.getOHLCValue(f, c), b = r, m = r;
                x.o > x.c && (d = !1);
                var v = Math.min(x.o, x.c), y = Math.max(x.o, x.c);
        ...
        key: "draw", value: function (t) {
            ...
            for (var h = o ? 0 : l.length - 1; o ? h < l.length : 0 <= h; o ? h++ : h--) {
                ...
                for (var g = 0, u = 0; u < l[h].length; u++) {
                    var p = 1, f = e.config.plotOptions.heatmap.shadeIntensity, x = this.determineHeatColor(h, u),
                    ...
                    var v, y, w, k = this.rectRadius, A = i.drawRect(g, n, s, r, k);
                    A.attr({cx: g, cy: n}), A.node.classList.add("apexcharts-heatmap-rect"), d.add(A), A.attr({
                        fill: b,
                        i: h,
                        index: h,
                        j: u,
        ...
        key: "determineHeatColor", value: function (t, e) {
            var i = this.w, a = i.globals.series[t][e], s = i.config.plotOptions.heatmap,
                ...
                l = Math.min.apply(Math, A(i.globals.series[t])), h = Math.max.apply(Math, A(i.globals.series[t]));
        ...
        key: "calculateHeatmapDataLabels", value: function (t) {
            var e, i, a, s, r, n = t.x, o = t.y, l = t.i, h = t.j, c = t.heatColorProps, d = (t.series, t.rectHeight),
                g = t.rectWidth, u = this.w, p = u.config.dataLabels, f = new Y(this.ctx), x = new N(this.ctx),
                b = p.formatter, m = null;
            return p.enabled && (m = f.group({class: "apexcharts-data-labels"}), e = p.offsetX, i = p.offsetY, a = n + g / 2 + e, s = o + d / 2 + parseFloat(p.style.fontSize) / 3 + i, r = b(u.globals.series[l][h], {
                seriesIndex: l,
                dataPointIndex: h,
                w: u
        ...
        key: "draw", value: function (t) {
            ...
            var p, f = i.config.plotOptions.pie.customScale, x = i.globals.gridWidth / 2, b = i.globals.gridHeight / 2,
                m = x - i.globals.gridWidth / 2 * f, v = b - i.globals.gridHeight / 2 * f;
            ...
            return this.sliceLabels.forEach(function (t) {
                w.add(t)
            }), o.attr({transform: "translate(".concat(m, ", ").concat(v, ") scale(").concat(f, ")")}), o.add(w), this.ret.add(o), this.donutDataLabels.show && (y = this.renderInnerDataLabels(this.donutDataLabels, {
        ...
        key: "drawArcs", value: function (t, e) {
            var i, a, s = this.w, r = new E(this.ctx), n = new Y(this.ctx), o = new R(this.ctx),
                l = n.group({class: "apexcharts-slices"}), h = s.config.plotOptions.pie.startAngle % this.fullAngle,
                c = h, d = h;
            ...
            for (var g = 0; g < t.length; g++) {
                ...
                var p, f = c < i ? this.fullAngle + c - i : c - i,
                    x = o.fillPath({seriesNumber: g, size: this.sliceSizes[g], value: e[g]}),
                    b = this.getChangedPath(a, d), m = n.drawPath({
                        d: b,
                ...
                !this.initialAnim || s.globals.resized || s.globals.dataChanged ? this.animBeginArr.push(0) : (0 == (T = f / this.fullAngle * s.config.chart.animations.speed) && (T = 1), this.animDur = T + this.animDur, this.animBeginArr.push(this.animDur)), this.dynamicAnim && s.globals.dataChanged ? this.animatePaths(m, {
                    ...
                    seriesIndex: g,
                    w: s
                })), S = s.globals.dataLabels.style.colors[g], C = n.group({class: "apexcharts-datalabels"}), L = n.drawText({
                    x: y,
                    y: w,
                    text: k,
                    textAnchor: "middle",
        ...
        key: "animateArc", value: function (e, i, a, s, r, n) {
            var o, l = this, t = this.w, h = new X(this.ctx), c = n.size;
            ...
            t.globals.dataChanged && n.shouldSetPrevPaths && n.prevEndAngle && (o = l.getPiePath({
                ...
                size: c
            }), e.attr({d: o})), 0 !== n.dur ? e.animate(n.dur, t.globals.easing, n.animBeginArr[n.i]).afterAll(function () {
                "pie" !== l.chartType && "donut" !== l.chartType && "polarArea" !== l.chartType || this.animate(t.config.chart.animations.dynamicAnimation.speed).attr({"stroke-width": l.strokeWidth}), n.i === t.config.series.length - 1 && h.animationCompleted(e)
            }).during(function (t) {
                d = u + (s - u) * t, n.animateStartingPos && (d = r + (s - r) * t, g = i - r + (a - (i - r)) * t), o = l.getPiePath({
                    ...
                    angle: d,
                    size: c
                }), e.node.setAttribute("data:pathOrig", o), e.attr({d: o})
            }) : (o = l.getPiePath({
                me: l,
                startAngle: g,
                angle: s,
        ...
        key: "pieClicked", value: function (t) {
            var e, i, a, s, r, n = this.w, o = this.sliceSizes[t] + (n.config.plotOptions.pie.expandOnClick ? 4 : 0),
            ...
            "true" !== l.attr("data:pieClicked") ? (e = n.globals.dom.baseEl.getElementsByClassName("apexcharts-pie-area"), Array.prototype.forEach.call(e, function (t) {
                ...
                angle: a,
                size: o
            }), 360 !== a && l.plot(s)) : (l.attr({"data:pieClicked": "false"}), this.revertDataLabelsInner(l.node, this.donutDataLabels), r = l.attr("data:pathOrig"), l.attr({d: r}))
        }
    }, {
        ...
        key: "getPiePath", value: function (t) {
            ...
            var l = Math.PI * (o - 90) / 180, h = e.centerX + s * Math.cos(n), c = e.centerY + s * Math.sin(n),
                ...
                p = I.polarToCartesian(e.centerX, e.centerY, e.donutSize, r), f = 180 < a ? 1 : 0,
        ...
        key: "drawPolarElements", value: function () {
            var t = this.w, e = new it(this.ctx), i = new Y(this.ctx), a = new Mt(this.ctx), s = i.group(),
                r = i.group(), n = void 0 === t.config.yaxis[0].max && void 0 === t.config.yaxis[0].min,
                o = e.niceScale(0, Math.ceil(this.maxY), t.config.yaxis[0].tickAmount, 0, n), l = o.result.reverse(),
                h = o.result.length;
            this.maxY = o.niceMax;
        ...
        key: "renderInnerDataLabels", value: function (t, e) {
            ...
            var n, o, l, h = e.centerX, c = e.centerY, d = void 0 === t.name.color ? i.globals.colors[0] : t.name.color,
                g = t.name.fontSize, u = t.name.fontFamily, p = t.value.fontWeight,
                f = void 0 === t.value.color ? i.config.chart.foreColor : t.value.color, x = t.value.formatter, b = "",
                m = "";
        ...
        key: "revertDataLabelsInner", value: function (t, a, e) {
            ...
            var s, r, n = this, o = this.w, l = o.globals.dom.baseEl.querySelector(".apexcharts-datalabels-group"),
                h = !1, c = o.globals.dom.baseEl.getElementsByClassName("apexcharts-pie-area");
            i({
                makeSliceOut: !0,
                printLabel: !1
        ...
        key: "draw", value: function (t) {
            var u = this, p = this.w, f = new R(this.ctx), x = [], b = new N(this.ctx);
            t.length && (this.dataPointsLen = t[p.globals.maxValsInArrayIndex].length), this.disAngle = 2 * Math.PI / this.dataPointsLen;
            var m, v, e, i = p.globals.gridWidth / 2, a = p.globals.gridHeight / 2,
                s = i + p.config.plotOptions.radar.offsetX, r = a + p.config.plotOptions.radar.offsetY,
                n = this.graphics.group({
                    class: "apexcharts-radar-series apexcharts-plot-series",
                    transform: "translate(".concat(s || 0, ", ").concat(r || 0, ")")
                }), y = null;
            return this.yaxisLabels = this.graphics.group({class: "apexcharts-yaxis"}), t.forEach(function (t, o) {
                var e = t.length === p.globals.dataPoints, l = u.graphics.group().attr({
                    class: "apexcharts-series",
                ...
                y = u.graphics.group({class: "apexcharts-series-markers-wrap apexcharts-element-hidden"}), v = u.graphics.group({
                    class: "apexcharts-datalabels",
                    "data:realIndex": o
                ...
                for (var r = 0; r < i.linePathsTo.length; r++) {
                    ...
                    l.add(n);
                    var h, c, d = f.fillPath({seriesNumber: o}), g = u.graphics.renderPaths(M(M({}, a), {}, {
                    ...
                    p.config.chart.dropShadow.enabled && (h = new E(u.ctx), c = p.config.chart.dropShadow, h.dropShadow(g, Object.assign({}, c, {noUserSpaceOnUse: !0}), o)), l.add(g)
                }
                t.forEach(function (t, e) {
                    ...
                    var s = u.graphics.group({class: "apexcharts-series-markers"});
            ...
            }), this.drawPolygons({parent: n}), p.config.xaxis.labels.show && (e = this.drawXAxisTexts(), n.add(e)), n.add(this.yaxisLabels), x.forEach(function (t) {
                n.add(t)
            }), n
        }
    }, {
        key: "drawPolygons", value: function (t) {
            ...
            i.forEach(function (t, a) {
                ...
                var i = r.polygons.strokeColors, a = r.polygons.strokeWidth,
        ...
        key: "drawXAxisTexts", value: function () {
            var n = this, o = this.w, l = o.config.xaxis.labels, h = this.graphics.group({class: "apexcharts-xaxis"}),
                c = this.getPolygonPos(this.size);
            return o.globals.labels.forEach(function (t, e) {
                var i, a, s = o.config.xaxis.labels.formatter, r = new N(n.ctx);
                c[e] && (i = n.getTextPos(c[e], n.size), a = s(t, {
                    ...
                    dataLabelsConfig: M({textAnchor: i.textAnchor, dropShadow: {enabled: !1}}, l),
                    offsetCorrection: !1
                }))
            }), h
        }
        ...
        key: "createPaths", value: function (i, t) {
            ...
            }), e.push(a), o.push(s)), {linePathsFrom: n, linePathsTo: e, areaPathsFrom: l, areaPathsTo: o}
        }
    }, {
        ...
        return n(s, [{
            key: "draw", value: function (t) {
                var e = this.w, i = new Y(this.ctx), a = i.group({class: "apexcharts-radialbar"});
                ...
                var c = this.drawArcs({size: o, centerX: n, centerY: r, colorArr: h, series: t}), d = 360;
            ...
            key: "drawTracks", value: function (t) {
                var e = this.w, i = new Y(this.ctx), a = i.group({class: "apexcharts-tracks"}), s = new E(this.ctx),
                    r = new R(this.ctx), n = this.getStrokeWidth(t);
                t.size = t.size - n / 2;
            ...
            key: "drawArcs", value: function (t) {
                var e = this.w, i = new Y(this.ctx), a = new R(this.ctx), s = new E(this.ctx), r = i.group(),
                ...
                var c, d = this.drawHollow({size: h, centerX: t.centerX, centerY: t.centerY, fill: o || "transparent"});
                ...
                for (var f = p ? t.series.length - 1 : 0; p ? 0 <= f : f < t.series.length; p ? f-- : f++) {
                    ...
                    var b = a.fillPath({seriesNumber: f, size: t.size, value: t.series[f]}), m = this.startAngle,
                        v = void 0, y = I.negToZero(100 < t.series[f] ? 100 : t.series[f]) / 100,
                        w = Math.round(this.totalAngle * y) + this.startAngle, k = void 0;
            ...
            key: "drawHollowImage", value: function (e, t, i, a) {
                var s, r, n, o, l = this.w, h = new R(this.ctx), c = I.randomId(),
        ...
        key: "calculatePoints", value: function (t) {
            var e, i = t.series, a = t.realIndex, s = t.x, r = t.y, n = t.i, o = t.j, l = t.prevY, h = this.w, c = [],
                d = [];
        ...
        key: "determineFirstPrevY", value: function (t) {
            ...
            if (void 0 !== i[e][0]) a = (s = r.config.chart.stacked && 0 < e ? this.lineCtx.prevSeriesY[e - 1][0] : this.lineCtx.zeroY) - i[e][0] / this.lineCtx.yRatio[this.lineCtx.yaxisIndex] + 2 * (this.lineCtx.isReversed ? i[e][0] / this.lineCtx.yRatio[this.lineCtx.yaxisIndex] : 0); else if (r.config.chart.stacked && 0 < e && void 0 === i[e][0]) for (var n = e - 1; 0 <= n; n--) if (null !== i[n][0] && void 0 !== i[n][0]) {
        ...
        key: "draw", value: function (t, e, i) {
            var a = this.w, s = new Y(this.ctx), r = a.globals.comboCharts ? e : a.config.chart.type,
                n = s.group({class: "apexcharts-".concat(r, "-series apexcharts-plot-series")}), o = new P(this.ctx, a);
            ...
            for (var l = [], h = 0; h < t.length; h++) {
                ...
                var p, f = u, x = f, b = this.zeroY,
                    b = this.lineHelpers.determineFirstPrevY({i: h, series: t, prevY: b, lineYPosition: 0}).prevY;
                d.push(b), p = b;
        ...
        key: "_calculatePathsFrom", value: function (t) {
            var e, i, a, s, r, n = t.series, o = t.i, l = t.realIndex, h = t.prevX, c = t.prevY, d = this.w,
                g = new Y(this.ctx);
            if (null === n[o][0]) {
                for (var u = 0; u < n[o].length; u++) if (null !== n[o][u]) {
        ...
        key: "_handlePaths", value: function (t) {
            var e = t.type, i = t.realIndex, a = t.i, s = t.paths, r = this.w, n = new Y(this.ctx), o = new R(this.ctx);
            ...
            if ("area" === e) for (var h = o.fillPath({seriesNumber: i}), c = 0; c < s.areaPaths.length; c++) {
            ...
            if (r.config.stroke.show && !this.pointsChart) for (var g = "line" === e ? o.fillPath({
                seriesNumber: i,
                i: a
        ...
        key: "_iterateOverDataPoints", value: function (t) {
            for (var e = t.series, i = t.realIndex, a = t.i, s = t.x, r = t.y, n = t.pX, o = t.pY, l = t.pathsFrom, h = t.linePaths, c = t.areaPaths, d = t.seriesIndex, g = t.lineYPosition, u = t.xArrj, p = t.yArrj, f = this.w, x = new Y(this.ctx), b = this.yRatio, m = l.prevY, v = l.linePath, y = l.areaPath, w = l.pathFromLine, k = l.pathFromArea, A = I.isNumber(f.globals.minYArr[i]) ? f.globals.minYArr[i] : f.globals.minY, S = 1 < f.globals.dataPoints ? f.globals.dataPoints - 1 : f.globals.dataPoints, C = 0; C < S; C++) {
                ...
                var T = this.lineHelpers.calculatePoints({series: e, x: s, y: r, realIndex: i, i: a, j: C, prevY: m}),
                    z = this._createPaths({
                        series: e,
                        i: a,
                        realIndex: i,
                        ...
                        areaPaths: c,
                        seriesIndex: d
                    }), c = z.areaPaths, h = z.linePaths, n = z.pX, o = z.pY, y = z.areaPath, v = z.linePath;
        ...
        key: "_handleMarkersAndLabels", value: function (t) {
            var e, i = t.pointsPos, a = (t.series, t.x, t.y, t.prevY, t.i), s = t.j, r = t.realIndex, n = this.w,
                o = new N(this.ctx);
        ...
        key: "_createPaths", value: function (t) {
            var e, i, a = t.series, s = t.i, r = t.realIndex, n = t.j, o = t.x, l = t.y, h = t.pX, c = t.pY,
                d = t.linePath, g = t.areaPath, u = t.linePaths, p = t.areaPaths, f = t.seriesIndex, x = this.w,
                b = new Y(this.ctx), m = x.config.stroke.curve, v = this.areaBottomY;
        ...
        key: "calculateTimeScaleTicks", value: function (t, e) {
            ...
            var i = new G(this.ctx), a = (e - t) / 864e5;
            ...
            var s = i.getTimeUnitsfromTimestamp(t, e, this.utc), r = o.globals.gridWidth / a, l = r / 24, h = l / 60,
                c = Math.floor(24 * a), d = Math.floor(24 * a * 60), g = Math.floor(a), u = Math.floor(a / 30),
                p = Math.floor(a / 365), f = {
            ...
            return b.filter(function (t) {
                var e = 1, i = Math.ceil(o.globals.gridWidth / 120), a = t.value;
        ...
        key: "generateYearScale", value: function (t) {
            var e, i = t.firstVal, a = t.currentMonth, s = t.currentYear, r = t.daysWidthOnXAxis, n = t.numberOfYears,
                o = i.minYear, l = 0, h = new G(this.ctx);
        ...
        key: "generateMonthScale", value: function (t) {
            var e, i, a, s = t.firstVal, r = t.currentMonthDate, n = t.currentMonth, o = t.currentYear,
                l = t.daysWidthOnXAxis, h = t.numberOfMonths, c = n, d = 0, g = new G(this.ctx), u = "month", p = 0;
            1 < s.minDate ? (d = (g.determineDaysOfMonths(n + 1, s.minYear) - r + 1) * l, c = I.monthMod(n + 1), e = o + p, i = I.monthMod(c), 0 === (a = c) && (u = "year", a = e, e += p += i = 1), this.timeScaleArray.push({
                ...
                year: e,
                month: i
            })) : this.timeScaleArray.push({position: d, value: c, unit: u, year: o, month: I.monthMod(n)});
            for (var f = c + 1, x = d, b = 0; b < h; b++) {
                0 === (f = I.monthMod(f)) ? (u = "year", p += 1) : u = "month";
                var m = this._getYear(o, f, p), x = g.determineDaysOfMonths(f, m) * l + x, v = 0 === f ? m : f;
                this.timeScaleArray.push({position: x, value: v, unit: u, year: m, month: 0 === f ? 1 : f}), f++
            }
        }
    }, {
        key: "generateDayScale", value: function (t) {
            ...
            var i = t.firstVal, a = t.currentMonth, s = t.currentYear, r = t.hoursWidthOnXAxis, n = t.numberOfDays,
                o = new G(this.ctx), l = "day", h = i.minDate + 1, c = h, d = (24 - i.minHour) * r, g = h,
                u = e(c, a, s);
            ...
            for (var p = d, f = 0; f < n; f++) {
                ...
                var x = this._getYear(s, u, 0), p = 24 * r + p, b = 1 === c ? I.monthMod(u) : c;
                this.timeScaleArray.push({position: p, value: b, unit: l, year: x, month: I.monthMod(u), day: b})
            }
        }
    }, {
        key: "generateHourScale", value: function (t) {
            ...
            var i = t.firstVal, a = t.currentDate, s = t.currentMonth, r = t.currentYear, n = t.minutesWidthOnXAxis,
                o = t.numberOfHours, l = new G(this.ctx), h = "hour", c = 60 - i.minMinute, d = c * n,
                g = i.minHour + 1, u = g + 1;
            60 == c && (d = 0, u = (g = i.minHour) + 1);
            var p = a, f = e(p, s);
            this.timeScaleArray.push({position: d, value: g, unit: h, day: p, hour: u, year: r, month: I.monthMod(f)});
            for (var x, b, m = d, v = 0; v < o; v++) {
                h = "hour", 24 <= u && (u = 0, h = "day", x = p += 1, b = f, x > l.determineDaysOfMonths(b + 1, r) && (b += p = 1), f = e(p, f = {
                    month: b,
                    date: p
                }.month));
                var y = this._getYear(r, f, 0), m = 0 === u && 0 === v ? c * n : 60 * n + m, w = 0 === u ? p : u;
        ...
        key: "generateMinuteScale", value: function (t) {
            var e = t.firstVal, i = t.currentMinute, a = t.currentHour, s = t.currentDate, r = t.currentMonth,
                ...
                c = e.minMinute + 1, d = c + 1, g = s, u = r, p = a;
            this.timeScaleArray.push({
                position: h,
                value: c,
                unit: "minute",
        ...
        key: "formatDates", value: function (t) {
            var o = this, l = this.w;
            return t.map(function (t) {
                var e, i, a = t.value.toString(), s = new G(o.ctx), r = o.createRawDateString(t, a), n = s.getDate(r),
        ...
        key: "removeOverlappingTS", value: function (s) {
            var r, n = this, o = new Y(this.ctx), l = !1;
            ...
            var h = 0, t = s.map(function (t, e) {
                if (0 < e && n.w.config.xaxis.labels.hideOverlappingLabels) {
                    var i = l ? r : o.getTextRects(s[h].value).width, a = s[h].position;
        ...
        key: "plotChartType", value: function (i, t) {
            var a = this.w, s = a.config, r = a.globals, n = {series: [], i: []}, o = {series: [], i: []},
                l = {series: [], i: []}, h = {series: [], i: []}, c = {series: [], i: []}, d = {series: [], i: []};
        ...
        key: "setSVGDimensions", value: function () {
            ...
            var i, a = I.getDimensions(this.el), s = e.chart.width.toString().split(/[0-9]+/g).pop();
        ...
        key: "resizeNonAxisCharts", value: function () {
            ...
            var s, r, n = t.globals.dom.baseEl.querySelector(".apexcharts-radialbar"), o = 2.05 * t.globals.radialSize;
            ...
            e.dom.elLegendForeign && e.dom.elLegendForeign.setAttribute("height", l), e.dom.elWrap.style.height = l + "px", Y.setAttrs(e.dom.Paper.node, {height: l}), e.dom.Paper.node.parentNode.parentNode.style.minHeight = l + "px"
        }
    }, {
        ...
        key: "resetGlobals", value: function () {
            ...
            var e = this, i = new q, a = this.w.globals;
        ...
        key: "setupBrushHandler", value: function () {
            ...
            r.config.chart.brush.enabled && "function" != typeof r.config.chart.events.selection && ((e = r.config.chart.brush.targets || [r.config.chart.brush.target]).forEach(function (t) {
                ...
                e.forEach(function (t) {
                    var a = ApexCharts.getChartByID(t), s = I.clone(r.config.yaxis);
                    ...
                    var e = a.w.config.yaxis.reduce(function (t, e, i) {
                        return [].concat(A(t), [M(M({}, a.w.config.yaxis[i]), {}, {min: s[0].min, max: s[0].max})])
                    }, []);
        ...
        key: "_updateOptions", value: function (i) {
            var a = this, s = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
                r = !(2 < arguments.length && void 0 !== arguments[2]) || arguments[2],
                t = !(3 < arguments.length && void 0 !== arguments[3]) || arguments[3],
                n = 4 < arguments.length && void 0 !== arguments[4] && arguments[4], e = [this.ctx];
        ...
        key: "_updateSeries", value: function (t, e) {
            var i, a = this, s = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], r = this.w;
            ...
            })).length && (i = [{data: []}]), r.config.series = i) : r.config.series = t.slice(), s && (r.globals.initialSeries = I.clone(r.config.series)), this.ctx.update()
        }
    }, {
    ...
    function Ge(t) {
        ...
        switch (t[0]) {
            ...
            case"A":
                t = (e = function (t, e) {
                    var i, a, s, r, n, o, l, h, c, d, g, u, p, f, x, b, m, v, y, w, k, A, S, C, L, P,
                        T = Math.abs(e[1]), z = Math.abs(e[2]), I = e[3] % 360, M = e[4], E = e[5], X = e[6], Y = e[7],
                        F = new SVG.Point(t), R = new SVG.Point(X, Y), D = [];
    ...
    t = "undefined" != typeof window ? window : void 0, L = function (s, r) {
        ...
        }, h.parser = {native: h.create("svg")}, r.addEventListener("DOMContentLoaded", function () {
        ...
        for (var l = {
            ...
            return function (t, e, i) {
                if ("H" == r) t[0] = t[0] + e.x; else if ("V" == r) t[0] = t[0] + e.y; else if ("A" == r) t[5] = t[5] + e.x, t[6] = t[6] + e.y; else for (var a = 0, s = t.length; a < s; ++a) t[a] = t[a] + (a % 2 ? e.y : e.x);
                return l[r](t, e, i)
            }
        }(t[e].toUpperCase());
        h.PathArray = function (t, e) {
            ...
            create: function (t) {
                ...
                animate: function (t, e, i) {
                    ...
                    var a = new h.Situation({duration: t || 1e3, delay: i || 0, ease: h.easing[e || "-"] || e});
                    ...
                    var e = this, t = this.target(), i = this.situation;
                    ...
                    if (i.transforms.length) {
                        ...
                        for (var s = i.transforms.length; a < s; a++) var r = i.transforms[a], n = r instanceof h.Matrix ? r.relative ? n.multiply((new h.Matrix).morph(r).at(i.ease(this.pos))) : n.morph(r).at(i.ease(this.pos)) : (r.relative || r.undo(n.extract()), n.multiply(r.at(i.ease(this.pos))));
                        t.matrix(n)
                    }
                    return this
                }, once: function (t, e, i) {
            ...
            create: function (t) {
                ...
                extract: function () {
                    var t = u(this, 0, 1), e = (u(this, 1, 0), 180 / Math.PI * Math.atan2(t.y, t.x) - 90);
                    return {
                        x: this.e,
                        y: this.f,
            ...
            create: function (t, e) {
                var i = Array.isArray(t) ? {x: t[0], y: t[1]} : "object" === v(t) ? {
                    x: t.x,
                    y: t.y
                } : null != t ? {x: t, y: null != e ? e : t} : {x: 0, y: 0};
            ...
            create: function (t, e) {
                ...
                if (Array.isArray(t)) for (var i = 0, a = this.arguments.length; i < a; ++i) this[this.arguments[i]] = t[i]; else if ("object" === v(t)) for (i = 0, a = this.arguments.length; i < a; ++i) this[this.arguments[i]] = t[this.arguments[i]];
            ...
            var r = i.bind(a || t.instance || t), n = (h.handlerMap.indexOf(t) + 1 || h.handlerMap.push(t)) - 1,
            ...
            var a = h.handlerMap.indexOf(t), s = e && e.split(".")[0], r = e && e.split(".")[1], n = "";
            if (-1 != a) if (i) {
            ...
            } else if (r) for (var l in h.listeners[a]) for (var n in h.listeners[a][l]) r === n && h.off(t, [l, r].join(".")); else if (s) {
                if (h.listeners[a][s]) {
        ...
        morph: function (t) {
            for (var e = this.value, i = this.parse(t), a = 0, s = 0; !1 !== a || !1 !== s;) {
                var r, n = _e(e, !1 !== a && a + 1), o = _e(i, !1 !== s && s + 1);
                ...
                var l = function (t, e, i, a, s, r, n) {
                    ...
                    }(e, a, n, i, s, o), e = e.slice(0, a).concat(l.start, !1 === n ? [] : e.slice(n)),
                    i = i.slice(0, s).concat(l.dest, !1 === o ? [] : i.slice(o)), a = !1 !== n && a + l.start.length,
        ...
        a.prototype.init = function (t, e) {
            ...
            var e, i = this.getBBox(), a = this.transformPoint(t),
        ...
        var e, s,
            ...
            n = (s = window.cancelAnimationFrame || window.mozCancelAnimationFrame || window.webkitCancelAnimationFrame || window.clearTimeout, function (t) {
                return s(t)
            }), t = !1, o = "animationstart", l = "Webkit Moz O ms".split(" "),
            h = "webkitAnimationStart animationstart oAnimationStart MSAnimationStart".split(" "),
            c = document.createElement("fakeelement");
        if (void 0 !== c.style.animationName && (t = !0), !1 === t) for (var d = 0; d < l.length; d++) if (void 0 !== c.style[l[d] + "AnimationName"]) {
            o = h[d];
            break
        }
    ...
    return n($e, [{
        ...
        key: "create", value: function (t, e) {
            ...
            var o = this.core.plotChartType(t, n), l = new N(this);
        ...
        key: "mount", value: function () {
            var o = this, l = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : null, h = this, c = h.w;
            return new Promise(function (t, e) {
                ...
                var a, s = new tt(o.ctx), r = new st(o.ctx);
                if (null !== i && (s.xAxisLabelCorrections(i.xAxisTickWidth), r.setYAxisTextAlignments()), "back" === c.config.annotations.position && (c.globals.dom.Paper.add(c.globals.dom.elAnnotations), h.annotations.drawAxesAnnotations()), l.elGraph instanceof Array) for (var n = 0; n < l.elGraph.length; n++) c.globals.dom.elGraphical.add(l.elGraph[n]); else c.globals.dom.elGraphical.add(l.elGraph);
                "front" === c.config.grid.position && i && c.globals.dom.elGraphical.add(i.el), "front" === c.config.xaxis.crosshairs.position && h.crosshairs.drawXCrosshairs(), "front" === c.config.yaxis[0].crosshairs.position && h.crosshairs.drawYCrosshairs(), "front" === c.config.annotations.position && (c.globals.dom.Paper.add(c.globals.dom.elAnnotations), h.annotations.drawAxesAnnotations()), c.globals.noData || (c.config.tooltip.enabled && !c.globals.noData && h.w.globals.tooltip.drawTooltip(l.xyRatios), c.globals.axisCharts && (c.globals.isXNumeric || c.config.xaxis.convertedCatToNumeric) ? (c.config.chart.zoom.enabled || c.config.chart.selection && c.config.chart.selection.enabled || c.config.chart.pan && c.config.chart.pan.enabled) && h.zoomPanSelection.init({xyRatios: l.xyRatios}) : (a = c.config.chart.toolbar.tools, ["zoom", "zoomin", "zoomout", "selection", "pan", "reset"].forEach(function (t) {
                    a[t] = !1
        ...
        key: "updateOptions", value: function (t) {
            var i = this, e = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
                ...
                r = !(4 < arguments.length && void 0 !== arguments[4]) || arguments[4], n = this.w;
        ...
        key: "addXaxisAnnotation", value: function (t) {
            var e = !(1 < arguments.length && void 0 !== arguments[1]) || arguments[1],
                i = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : void 0, a = i || this;
        ...
        key: "clearAnnotations", value: function () {
            var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : void 0, e = t || this;
            e.annotations.clearAnnotations(e)
        }
    }, {
        key: "removeAnnotation", value: function (t) {
            var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : void 0, i = e || this;
